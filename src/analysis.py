...
_ACTION_LABELS = {
    ...
    "emit_red": "Red Pheromone Reflexes",
    "emit_green": "Green Pheromone Reflexes",
    "emit_blue": "Blue Pheromone Reflexes",
...
_ACTION_PRIMARY_LABELS = {
    ...
    "emit_red": "Emit red pheromone",
    "emit_green": "Emit green pheromone",
    "emit_blue": "Emit blue pheromone",
    "rest": "Rest / recover",
}
...
_SENSORY_PRIMARY_LABELS = {
    ...
    "local_richness": "Local richness",
    "lateral_gradient": "Left/right richness gradient",
    "forward_gradient": "Forward richness gradient",
    ...
    "pheromone_local_red": "Local red pheromone",
    "pheromone_local_green": "Local green pheromone",
    "pheromone_local_blue": "Local blue pheromone",
    "pheromone_lateral_red": "Lateral red pheromone gradient",
    "pheromone_lateral_green": "Lateral green pheromone gradient",
    "pheromone_lateral_blue": "Lateral blue pheromone gradient",
    "pheromone_forward_red": "Forward red pheromone gradient",
    "pheromone_forward_green": "Forward green pheromone gradient",
    "pheromone_forward_blue": "Forward blue pheromone gradient",
...
_SENSORY_DESCRIPTIONS = {
    ...
    "local_richness": "Local Expected Food Density (Richness)",
    "lateral_gradient": "Body-Frame Lateral Richness Gradient",
    "forward_gradient": "Body-Frame Forward Richness Gradient",
    "own_infant_proximity": "Nearest Offspring Distance",
    "own_infant_angle": "Nearest Offspring Direction",
    ...
    "pheromone_local_red": "Local Red Pheromone Intensity",
    "pheromone_local_green": "Local Green Pheromone Intensity",
    "pheromone_local_blue": "Local Blue Pheromone Intensity",
    "pheromone_lateral_red": "Lateral Red Pheromone Gradient",
    "pheromone_lateral_green": "Lateral Green Pheromone Gradient",
    "pheromone_lateral_blue": "Lateral Blue Pheromone Gradient",
    "pheromone_forward_red": "Forward Red Pheromone Gradient",
