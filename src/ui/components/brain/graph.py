...
class BrainGraphComponent:
    ...
    def _short_brain_label(self, label: str) -> str:
        ...
        replacements = {
            ...
            "wall_angle": "w_a",
            "is_grabbing": "holding",
            "local_richness": "bio_local",
            "lateral_gradient": "bio_lat",
            "forward_gradient": "bio_fwd",
            ...
            "sound_tone": "tone",
            "pheromone_local_red": "red_local",
            "pheromone_local_green": "green_local",
            "pheromone_local_blue": "blue_local",
            "pheromone_lateral_red": "red_lateral",
            "pheromone_lateral_green": "green_lateral",
            "pheromone_lateral_blue": "blue_lateral",
            "pheromone_forward_red": "red_forward",
            "pheromone_forward_green": "green_forward",
            "pheromone_forward_blue": "blue_forward",
